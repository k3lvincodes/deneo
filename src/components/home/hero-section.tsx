  ...
  return (
    <section className="relative py-24 md:py-32 lg:py-48 text-center bg-gradient-to-b from-background to-primary/10">
      ...
      <div className="container relative z-10 mx-auto">
        <h1 className="font-headline text-4xl md:text-5xl lg:text-6xl font-bold tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-foreground to-foreground/70">
